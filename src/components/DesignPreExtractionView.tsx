    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-purple-500/25 bg-gradient-to-br from-slate-900 via-slate-950 to-purple-950/20 p-5 sm:p-8 shadow-2xl">
        <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-5">
          ...
          <div className="rounded-2xl border border-amber-500/25 bg-amber-500/5 p-4 text-xs leading-5 text-slate-300 xl:max-w-sm"><Info className="mr-1 inline h-4 w-4 text-amber-300" />DESIGN.md는 2026년 Google이 공개한 오픈 포맷이지만 현재 사양 버전은 <strong className="text-amber-200">alpha</strong>입니다. YAML front matter의 token 값과 Markdown prose는 실제 프로젝트 근거를 확인한 뒤 채우고, 범용 starter에서 임의의 디자인을 만들지 않습니다.</div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          ['2', 'DESIGN.md 맞춤화', '확인된 token과 디자인 rationale만 프로젝트 계약으로 기록합니다.'],
